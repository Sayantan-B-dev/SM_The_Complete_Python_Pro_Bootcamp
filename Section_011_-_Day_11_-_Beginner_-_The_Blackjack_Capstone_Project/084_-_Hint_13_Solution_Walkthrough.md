### STEP 5 — GAME LOOP, BETTING, REPLAY & TERMINAL UX

---

## GOAL OF STEP 5

* Tie **all previous steps together**
* Add:
...
## GAME LOOP STRATEGY (CONTROL FLOW)

| Phase       | Responsibility                 |
| ----------- | ------------------------------ |
| Game start  | Initialize balance             |
| Round start | Ask bet, create & shuffle deck |
| Deal        | Give initial cards             |
| Player turn | Hit / Stand / Double           |
| Dealer turn | Automatic                      |
| Resolve     | Win / Lose / Push              |
| Update      | Balance update                 |
| Replay      | Continue or exit               |

---

## FINAL — FULL BLACKJACK TERMINAL GAME CODE
...
## SAMPLE FULL GAME RUN (ABRIDGED OUTPUT)
...
* Modular design
* Safe input handling
* Correct blackjack logic
* Easily extendable (split, blackjack payout, insurance)

Next logical extensions (when ready):
